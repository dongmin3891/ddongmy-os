...
import { developmentLogs, findDevelopmentLog } from '@/features/development-log/development-logs'
...
export async function generateMetadata({ params }: DevelopmentLogEntryPageProps): Promise<Metadata> {
  ...
  const log = findDevelopmentLog(slug)
  ...
  return (
    <article className="mx-auto max-w-3xl">
      ...
      <header className="mt-8 space-y-5 border-b border-slate-700 pb-8">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-primary-400">Draft</p>
